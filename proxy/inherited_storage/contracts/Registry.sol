...
contract Registry is IRegistry,Ownable {
    ...
    */
    function addVersion(string version, address implementation) onlyOwner public {
    ...
    */
    function createProxy(string version) onlyOwner public payable returns (UpgradeabilityProxy) {
